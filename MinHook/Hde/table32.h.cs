...
namespace MinHooking.Hde {
	internal static unsafe class Table32 {
		...
		public const ushort DELTA_FPU_REG = 0xf1;
		public const ushort DELTA_FPU_MODRM = 0xf8;
		...
		public static readonly byte* hde32_table;

		public static readonly byte[] _hde32_table = {
		...
		static Table32() {
			...
			hTable = GCHandle.Alloc(_hde32_table, GCHandleType.Pinned);
			hde32_table = (byte*)hTable.AddrOfPinnedObject();
		}
	}
}
